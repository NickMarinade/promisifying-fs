...
const appendAssert = async (toAppend, toRead) => {
  try {
    ...
    const newContent = await readFilePromise(toAppend, 'utf-8');
...
appendAssert(fileToAppend, fileToRead);
